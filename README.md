<h1 align="center">Hello! I am Isha Parikh</h1>
...
<div style="font-family: 'Times New Roman', Times, serif;"> 
  ...
  <strong>About me:</strong> On a daily basis, I work with bioinformatics tools, scRNA-seq workflows, and Nextflow pipelines to study cancer and other diseases through an immunology lens (work that has become second nature over time). That foundation has naturally led me to expand into spatial everything, from transcriptomics to proteomics, as I follow my curiosity into newer and more complex layers of biological data. As these technologies evolve, so does my interest in learning how LLMs can support in reshaping genomics and precision medicine, particularly in helping accelerate the path from data to therapies for patients. And when my mind drifts beyond this, it often wanders into Martian territory, thinking about space biology and how life can survive in environments far beyond Earth.
  
  This page captures my journey of trying, failing, learning, and (hopefully) succeeding as I push boundaries and take on new challenges.
